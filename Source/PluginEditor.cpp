...
namespace SampleGod {
PluginEditor::PluginEditor(PluginProcessor& p) : AudioProcessorEditor(&p), processorRef(p) { setSize(800, 600); addAndMakeVisible(browser); addAndMakeVisible(waveform); }
